import {serverApi, getServerErrorMessage, getTokenHeaders} from "@/shared";
import type {BackendApiResponse} from "@/shared/types";
import {ActivityDataStructure, ActivityDifficultyStructure, ActivityTypeStructure} from "@/entities/activity/model/type";
