                        ...
                        <div className="relative z-10 flex flex-col gap-4">
                            <div className="space-y-4">
                                ...
                                <h2 className="text-xl font-bold leading-tight sm:text-2xl">
                                    Меняйте почту осознанно и подтверждайте действие текущим паролем
                                </h2>
                                ...
                                <div className="grid gap-4">
                                    <div className="rounded-xl border border-white/20 bg-white/10 p-3 backdrop-blur-sm">
                                        <div className="flex items-center gap-2 text-sm font-semibold">
                                            ...
                                            Актуальная почта важна для восстановления доступа
                                        </div>
                                    </div>
                                    ...
                                    <div className="rounded-xl border border-white/20 bg-white/10 p-3 backdrop-blur-sm">
                                        <div className="flex items-center gap-2 text-sm font-semibold">
                                            ...
                                            Подтверждение паролем защищает изменение данных
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <p className="text-sm text-emerald-50/95">
                                После сохранения в профиле отобразится новый email.
                            </p>
                        </div>
                    </aside>
                </div>
