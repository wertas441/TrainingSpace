        ...
        <div className="flex flex-col justify-between h-full rounded-2xl bg-white border border-emerald-100 shadow-sm p-5 gap-4">
            ...
            <div className="flex flex-col items-center justify-center gap-3">
                <div className="mt-2 flex items-baseline gap-1">
                    <span className="text-4xl sm:text-5xl font-mono font-semibold text-emerald-800">
                        {formatTime(seconds)}
                    </span>
                </div>
            </div>
            ...
            <div className="mt-2 flex items-center justify-center gap-3">
                <button
                    type="button"
                    onClick={toggle}
                    className={`inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold shadow-sm transition 
                    ${isRunning
                ...
                <button
                    type="button"
                    onClick={reset}
                    className="inline-flex items-center justify-center rounded-full px-4 py-2 text-xs font-medium text-emerald-700 border border-emerald-200 hover:bg-emerald-50 transition"
                >
