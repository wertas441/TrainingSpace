...
CREATE INDEX IF NOT EXISTS idx_training_public_id ON training(public_id);
...
CREATE INDEX IF NOT EXISTS idx_activity_public_id ON activity(public_id);
...
CREATE INDEX IF NOT EXISTS idx_goal_public_id ON goal(public_id);
